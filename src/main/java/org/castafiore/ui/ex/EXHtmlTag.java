...
public abstract class EXHtmlTag extends EXComponent implements HTMLTag , Container
{
	...
	//protected String[][] attributes_ = null; 
	
	//protected String[][] styles_ = null;
	...
	public Container setAttribute(String name, Var value){
		...
		//attributes_ = StringUtil.addOrUpdateItem(name, "js::-" + txt, attributes_);
		if(value == null){
	...
	public Container setStyle(String name, Var var) 
	{
		...
		if(var == null){
			...
			//styles_ = StringUtil.addOrUpdateItem(name, "js::-" + txt, styles_);
