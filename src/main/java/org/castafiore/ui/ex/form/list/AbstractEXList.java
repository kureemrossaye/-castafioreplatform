 ...
 * Oct 22, 2008
 */
public abstract class AbstractEXList<T> extends AbstractStatefullComponent<T>
{
	...
	public void refresh() {
		...
		for(int i = 0; i < size; i ++)
		{
			...
			ListItem<T> container = renderer_.getCellAt(i, value, model_);
			addItem(container);
		}
	...
	public abstract ListItem<T> getItem(int index);
