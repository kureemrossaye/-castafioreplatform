...
public final class Var implements JSObject {
	...
	/**
	 * builds an expression that verifies if the specified {@link Var} equals this {@link Var}
	 * @param var
	 * @return
	 */
	...
	/**
	 * builds an expression that verifies if the specified variable equals this {@link Var}
	 * @param var
	 * @return
	 */
	...
	/**
	 * builds an expression that verifies if the specified {@link Var} is greater this {@link Var}
	 * @param var
	 * @return
	 */
	...
	/**
	 * builds an expression that verifies if the specified {@link Var} is less this {@link Var}
	 * @param var
	 * @return
	 */
	...
	/**
	 * builds an expression that verifies if the specified {@link Var} less or equal this {@link Var}
	 * @param var
	 * @return
	 */
	...
	/**
	 * builds an expression that verifies if the specified {@link Var} greater or equal this {@link Var}
	 * @param var
	 * @return
	 */
