...
public class EXLoginForm extends EXDynaformPanel {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 6001280333753404563L;

	private List<OnLoginHandler> onLoginHandlers = new ArrayList<OnLoginHandler>(1);
	
	private List<OnRegisterUserHandler> onRegisterUserHandlers = new ArrayList<OnRegisterUserHandler>();
	
	private SecurityService service;

	public EXLoginForm(String name, SecurityService service) {
		super(name, "Login");
